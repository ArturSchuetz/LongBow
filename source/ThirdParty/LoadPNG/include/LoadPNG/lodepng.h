...
#ifdef LOADPNG_STATIC_DEFINE
#define LOADPNG_API
#define LOADPNG_NO_EXPORT
#else
#ifndef LOADPNG_API
#ifdef LoadPNG_EXPORTS
/* We are building this library */
#define LOADPNG_API __declspec(dllexport)
#else
/* We are using this library */
#define LOADPNG_API __declspec(dllimport)
#endif
#endif

#ifndef LOADPNG_NO_EXPORT
#define LOADPNG_NO_EXPORT
#endif
#endif

#ifndef LOADPNG_DEPRECATED
#define LOADPNG_DEPRECATED __declspec(deprecated)
#endif

#ifndef LOADPNG_DEPRECATED_EXPORT
#define LOADPNG_DEPRECATED_EXPORT LOADPNG_API LOADPNG_DEPRECATED
#endif

#ifndef LOADPNG_DEPRECATED_NO_EXPORT
#define LOADPNG_DEPRECATED_NO_EXPORT LOADPNG_NO_EXPORT LOADPNG_DEPRECATED
#endif

#if 0 /* DEFINE_NO_DEPRECATED */
#ifndef LOADPNG_NO_DEPRECATED
#define LOADPNG_NO_DEPRECATED
#endif
#endif
...
LOADPNG_API unsigned decode(std::vector<unsigned char> &out, unsigned &w, unsigned &h, const unsigned char *in, size_t insize, LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
LOADPNG_API unsigned decode(std::vector<unsigned char> &out, unsigned &w, unsigned &h, const std::vector<unsigned char> &in, LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
#ifdef LODEPNG_COMPILE_DISK
/*
...
to handle such files and decode in-memory.
*/
LOADPNG_API unsigned decode(std::vector<unsigned char> &out, unsigned &w, unsigned &h, const std::string &filename, LodePNGColorType colortype = LCT_RGBA, unsigned bitdepth = 8);
#endif /* LODEPNG_COMPILE_DISK */
#endif /* LODEPNG_COMPILE_DECODER */
...
LOADPNG_API const char *lodepng_error_text(unsigned code);
...
*/
LOADPNG_API unsigned lodepng_decode(unsigned char **out, unsigned *w, unsigned *h, LodePNGState *state, const unsigned char *in, size_t insize);
...
{
#ifdef LODEPNG_COMPILE_PNG
class LOADPNG_API State : public LodePNGState
{
  public:
    State();
...
LOADPNG_API unsigned decode(std::vector<unsigned char> &out, unsigned &w, unsigned &h, State &state, const unsigned char *in, size_t insize);
LOADPNG_API unsigned decode(std::vector<unsigned char> &out, unsigned &w, unsigned &h, State &state, const std::vector<unsigned char> &in);
#endif /*LODEPNG_COMPILE_DECODER*/
