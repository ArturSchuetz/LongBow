...
{
    FN("SubdivisionSphereTessellator::ComputeFromTetrahedron");
    ...
    const float negativeRootTwoOverThree = -sqrt(2.0) / 3.0;
    const float negativeOneThird = -1.0 / 3.0;
    const float rootSixOverThree = sqrt(6.0) / 3.0;
...
{
    FN("SubdivisionSphereTessellator::ComputeFromCube");
    ...
    Vector3<float> v0 = Vector3<float>(-1.0, -1.0, -1.0);
    v0.Normalize();
    Vector3<float> v1 = Vector3<float>(1.0, -1.0, -1.0);
    v1.Normalize();
    Vector3<float> v2 = Vector3<float>(1.0, 1.0, -1.0);
    v2.Normalize();
    Vector3<float> v3 = Vector3<float>(-1.0, 1.0, -1.0);
    v3.Normalize();
    Vector3<float> v4 = Vector3<float>(-1.0, -1.0, 1.0);
    v4.Normalize();
    Vector3<float> v5 = Vector3<float>(1.0, -1.0, 1.0);
    v5.Normalize();
    Vector3<float> v6 = Vector3<float>(1.0, 1.0, 1.0);
    v6.Normalize();
    Vector3<float> v7 = Vector3<float>(-1.0, 1.0, 1.0);
    v7.Normalize();
...
{
    FN("SubdivisionSphereTessellator::ComputeFromOctahedron");
    ...
    Vector3<float> v0 = Vector3<float>(1.0, 0.0, 0.0);
    v0.Normalize();
    Vector3<float> v1 = Vector3<float>(0.0, -1.0, 0.0);
    v1.Normalize();
    Vector3<float> v2 = Vector3<float>(-1.0, 0.0, 0.0);
    v2.Normalize();
    Vector3<float> v3 = Vector3<float>(0.0, 1.0, 0.0);
    v3.Normalize();
    Vector3<float> v4 = Vector3<float>(0.0, 0.0, 1.0);
    v4.Normalize();
    Vector3<float> v5 = Vector3<float>(0.0, 0.0, -1.0);
    v5.Normalize();
...
{
    FN("SubdivisionSphereTessellator::ComputeFromIcosahedron");
    ...
    VertexAttributeFloatVec3 *normalsAttribute = new VertexAttributeFloatVec3("in_Normal");
    mesh.AddAttribute(VertexAttributePtr(normalsAttribute));

    VertexAttributeFloatVec4 *colorsAttribute = new VertexAttributeFloatVec4("in_Color");
    ...
    Vector3<float> v0 = Vector3<float>(-X, 0.0, Z);
    v0.Normalize();
    Vector3<float> v1 = Vector3<float>(X, 0.0, Z);
    v1.Normalize();
    Vector3<float> v2 = Vector3<float>(-X, 0.0, -Z);
    v2.Normalize();
    Vector3<float> v3 = Vector3<float>(X, 0.0, -Z);
    v3.Normalize();
    Vector3<float> v4 = Vector3<float>(0.0, Z, X);
    v4.Normalize();
    Vector3<float> v5 = Vector3<float>(0.0, Z, -X);
    v5.Normalize();
    Vector3<float> v6 = Vector3<float>(0.0, -Z, X);
    v6.Normalize();
    Vector3<float> v7 = Vector3<float>(0.0, -Z, -X);
    v7.Normalize();
    Vector3<float> v8 = Vector3<float>(Z, X, 0.0);
    v8.Normalize();
    Vector3<float> v9 = Vector3<float>(-Z, X, 0.0);
    v9.Normalize();
    Vector3<float> v10 = Vector3<float>(Z, -X, 0.0);
    v10.Normalize();
    Vector3<float> v11 = Vector3<float>(-Z, -X, 0.0);
    v11.Normalize();
    ...
    normalsAttribute->Values.resize(positionsAttribute->Values.size());
    for (size_t i = 0; i < normalsAttribute->Values.size(); i++)
    {
        normalsAttribute->Values[i] = positionsAttribute->Values[i].Normalized();
    }

    colorsAttribute->Values.resize(positionsAttribute->Values.size());
    for (size_t i = 0; i < colorsAttribute->Values.size(); i++)
    {
        colorsAttribute->Values[i] = bow::Vector4<float>(1.0f, 1.0f, 1.0f, 0.5f);
    }
    return mesh;
}
...
{
    FN("SubdivisionSphereTessellator::Subdivide");
...
{
    FN("SubdivisionSphereTessellator::ComputeTextureCoordinate");

    return Vector2<float>((float)((atan2((float)position.y, (float)position.x)) * (1.0 / (2.0 * M_PI)) + 0.5), (float)(asin((float)position.z) * (1.0 / M_PI) + 0.5));
}
} // namespace bow
