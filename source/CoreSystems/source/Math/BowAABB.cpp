...
MeshAttribute CreateDebugMesh(const AABB<float> &aabb, const std::string &vertexAttributeName)
{
    ...
    indices->Values.push_back(2);
    indices->Values.push_back(3);
    indices->Values.push_back(1);
    indices->Values.push_back(3);

    indices->Values.push_back(4);
    indices->Values.push_back(5);
    indices->Values.push_back(4);
    indices->Values.push_back(6);
    indices->Values.push_back(6);
    indices->Values.push_back(7);
    indices->Values.push_back(5);
    indices->Values.push_back(7);
    ...
    VertexAttributeFloatVec3 *positionsAttribute = new VertexAttributeFloatVec3(vertexAttributeName, (int)boxVertices.size());
