...
#include "CoreSystems/Math/BowMathFunctions.h"
...
template <typename T> class Quaternion
{
  public:
    ...
    Quaternion() : _q(bow::Vector4<T>((T)0, (T)0, (T)0, (T)1)) { FN("Quaternion::Quaternion"); }
    //
    Quaternion(T x, T y, T z, T w) : _q(bow::Vector4<T>(x, y, z, w)) { FN("Quaternion::Quaternion"); }

    //! Constructor for a Quaternion from a 3D (rotation) matrix.
    //! Matrices here are [row][column], row major.
    //! Taken from 'From Quaterninon to Matrix and Back', J.M.P. van Waveren,
    //! February 27th 2005
    /*!
        \param m Rotation matrix, of which an corresponding quaternion is
       constructed. \warning The representation of a rotation as a quaternion is
       not unique!
    */
    Quaternion(const bow::Matrix3D<T> &m)
    {
        ...
        if (m._11 + m._22 + m._33 > 0.0)
        {
            ...
            T s = bow::math::ReciprocalSqrt(t) * (T)0.5;
    ...
    */
    ...
    /*!
        ...
        \param rhs The other quaternion to be added elementwise with this
       quaternion. \return The new quaternion, as a result of the addition.
    */
    ...
    */
    ...
    //!  Elementwise multiplication of the quaternion with a scalar from the
    //!  right hand side and replacing it
    /*!
        \param rhs Righthand side scalar for the multiplication.
        \return A new multiplication equaled (*=) quatenion as a result of the
    ...
    */
    ...
    //! Elementwise multiplication of the quaternion with a scalar from the left
    //! hand side and returning a new resulting quaternion.
    /*!
    ...
    */
    ...
    //! Quaternion multiplication operator, with another quaternion and
    //! replacing it.
    /*!
    ...
    *
        ...
        \f$
    *
    * Collecting components and using identities of components listed above
    results in:
    *
        \f$
    ...
    *
    * Taken from
    'https://www.gamasutra.com/view/feature/131686/rotating_objects_using_quaternions.php?page=2'.
    * Smart rearrangement of quaternion element equations, so parts of an
    element of the equation are reused as much as possible,
    ...
    */
    ...
    //! Quaternion multiplication operator, with another quaternion resulting in
    //! a new quaternion.
    /*!
    ...
    */
    Quaternion Slerp(float t, const Quaternion &q1, const Quaternion &q2)
    {
        ...
        // If target and destination quaternion distance is too small use direct
        // interpolation.
