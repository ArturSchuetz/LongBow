...
template <typename T> class Matrix2D
{
  public:
    ...
    {
        FN("Matrix2D::Determinant");

        return _11 * _22 - _12 * _21;
    }

    inline Matrix2D Adjugate() const
    {
        FN("Matrix2D::Adjugate");
    ...
    {
        FN("Matrix2D::Translate");

        (*this) *= Matrix2D((T)1, (T)0, (T)vector.x, (T)0, (T)1, (T)vector.y, (T)0, (T)0, (T)1);
    }
    ...
    {
        FN("Matrix2D::operator*");

        return Matrix2D(_11 * other._11 + _12 * other._21 + _13 * other._31, _11 * other._12 + _12 * other._22 + _13 * other._32, _11 * other._13 + _12 * other._23 + _13 * other._33,
    ...
    inline Vector2<T> operator*(const Vector2<T> &vector) const
    {
        ...
        return Vector2<T>(_11 * vector.x + _12 * vector.y + _13, _21 * vector.x + _22 * vector.y + _23);
    }
    ...
    inline Vector3<T> operator*(const Vector3<T> &vector) const
    {
        ...
        return Vector3<T>(_11 * vector.x + _12 * vector.y + _13 * vector.z, _21 * vector.x + _22 * vector.y + _23 * vector.z, _31 * vector.x + _32 * vector.y + _33 * vector.z);
    }
    ...
    inline Matrix2D operator*(const T &scalar) const
    {
        ...
        return Matrix2D(_11 * scalar, _12 * scalar, _13 * scalar, _21 * scalar, _22 * scalar, _23 * scalar, _31 * scalar, _32 * scalar, _33 * scalar);
    }
    ...
    inline void operator*=(const Matrix2D &other)
    {
        ...
        Set(_11 * other._11 + _12 * other._21 + _13 * other._31, _11 * other._12 + _12 * other._22 + _13 * other._32, _11 * other._13 + _12 * other._23 + _13 * other._33,
    ...
    template <typename C> inline operator Matrix2D<C>()
    {
        FN("Matrix2D::Matrix2D");
