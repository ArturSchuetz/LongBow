...
{
  protected:
    ITextureSampler(TextureMinificationFilter minificationFilter, TextureMagnificationFilter magnificationFilter, TextureWrap wrapS, TextureWrap wrapT, float maximumAnistropy)
        : MinificationFilter(minificationFilter), MagnificationFilter(magnificationFilter), WrapS(wrapS), WrapT(wrapT), MaximumAnistropy(maximumAnistropy)
    {
    }
