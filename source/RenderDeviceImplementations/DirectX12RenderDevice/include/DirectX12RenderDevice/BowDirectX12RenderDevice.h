#pragma once
#include <DirectX12RenderDevice/BowDirectX12RenderDevicePredeclares.h>
#include <DirectX12RenderDevice/DirectX12RenderDevice_api.h>
...
class DirectX12RenderDevice : public IRenderDevice
{
  public:
    ...
    ///=========================================================================
    //// DirectX12 INTERNAL STUFF:
    ///=========================================================================

  private:
    // you shall not copy!
    DirectX12RenderDevice(const DirectX12RenderDevice &) = delete;
    DirectX12RenderDevice &operator=(const DirectX12RenderDevice &) = delete;
