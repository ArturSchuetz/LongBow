...
class RESOURCES_API MeshManager : public ResourceManager
{
  public:
    ~MeshManager();
  ...
  private:
    MeshManager(const MeshManager &) = delete;            // You shall not copy
    MeshManager &operator=(const MeshManager &) = delete; // You shall not assign
    MeshManager();
