...
class RESOURCES_API PointCloudManager : public ResourceManager
{
  public:
    ~PointCloudManager();
  ...
  private:
    PointCloudManager(const PointCloudManager &) = delete;            // You shall not copy
    PointCloudManager &operator=(const PointCloudManager &) = delete; // You shall not assign
    PointCloudManager();
