...
Bow::Core::Matrix3D<float> GameObject::constructPitchMatrix(const float pitch)
{
...
Bow::Core::Matrix3D<float> GameObject::constructYawMatrix(const float yaw)
{
...
Bow::Core::Matrix3D<float> GameObject::constructRollMatrix(const float roll)
{
...
void GameObject::updateRotation(float yaw, float pitch, float roll)
{
	...
	Bow::Core::Vector4<float> newDir = m_currentRotationMatrix * m_initialRotationMatrix * Bow::Core::Vector4<float>(m_inititalDir.x, m_inititalDir.y, m_inititalDir.z, 0.0f);
