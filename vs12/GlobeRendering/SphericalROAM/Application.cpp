...
bool Application::Init(void)
{
	...
	// Creating Window
	m_window = m_device->VCreateWindow(800, 600, "ROAM Level Of Detail", Renderer::WindowType::Windowed);
	if (m_window == nullptr)
	{
		return false;
	}
...
{	
	...
	m_Planet.Init(m_contextOGL, shaderProgram, terrainDiffuseTexture, sampler, "../Data/Textures/NASA/gebco_08_rev_elev_21600x10800.png");
...
void Application::Render(void)
{
	...
	float fMaxError = 1.0f;
	m_Planet.Tessellate(m_camera->GetPosition(), fMaxError);
	m_Planet.Render(m_contextOGL, m_camera);
