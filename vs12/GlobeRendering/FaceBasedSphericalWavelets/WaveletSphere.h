...
private:
	...
	void RecursRender(WaveletTriangle* triangle, Bow::Core::VertexAttributeFloatVec3 *positionsAttribute, Bow::Core::VertexAttributeFloat *heightAttribute, Bow::Core::VertexAttributeFloat *colorAttribute);
	void RecursRenderDetail(WaveletTriangle* triangle, Bow::Core::VertexAttributeFloatVec3 *positionsAttribute, Bow::Core::VertexAttributeFloat *heightAttribute, Bow::Core::VertexAttributeFloat *colorAttribute);
