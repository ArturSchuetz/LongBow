	...
	m_Up(worldUp)
{
	...
	m_Phi = Pi * 1.0f;             // schraeg durchs Gelaende schauen 
...
void FirstPersonCamera::MoveForward(DWORD deltaTime)
{
...
void FirstPersonCamera::MoveBackward(DWORD deltaTime)
{
	Core::Vector3<float> delta = m_Dir * m_Speed * (float)deltaTime;
	m_Position -= delta;
...
void FirstPersonCamera::MoveRight(DWORD deltaTime)
{
...
void FirstPersonCamera::MoveLeft(DWORD deltaTime)
{
	Core::Vector3<float> vcTemp, vcUp;
...
void FirstPersonCamera::MoveUp(DWORD deltaTime)
{
...
void FirstPersonCamera::MoveDown(DWORD deltaTime)
{
	Core::Vector3<float> delta = m_Up * m_Speed * (float)deltaTime;
	m_Position -= delta;
