...
namespace Bow {
    ...
    {
		FN("OGLFramebuffer::GetDepthStencilAttachment()");
		return m_depthStencilAttachment;
    }

	void OGLFramebuffer::SetDepthStencilAttachment(Texture2DPtr texture)
    {
		FN("OGLFramebuffer::SetDepthStencilAttachment()");
