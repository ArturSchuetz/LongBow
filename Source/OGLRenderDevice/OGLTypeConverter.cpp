...
namespace Bow{
	...
	{
		FN("OGLTypeConverter::To(ClearBuffers mask)");
	...
	{
		FN("BufferHint OGLTypeConverter::To(BufferUsageHint)");
		switch (hint)
		{
			case GL_STREAM_DRAW:
		...
		LOG_ASSERT(false, "BufferUsageHint does not exist.");
	}

	GLenum OGLTypeConverter::To(BufferHint hint)
	{
		FN("BufferUsageHint OGLTypeConverter::To(BufferHint)");
		switch (hint)
		{
		...
		LOG_ASSERT(false, "BufferHint does not exist.");
	}


	GLenum OGLTypeConverter::To(ComponentDatatype type)
	{
		FN("GLenum OGLTypeConverter::To(ComponentDatatype)");
		switch (type)
		{
		...
		LOG_ASSERT(false, "ComponentDatatype does not exist.");
		return GL_NONE;
	}

	GLenum OGLTypeConverter::To(PrimitiveType type)
	{
		FN("GLenum OGLTypeConverter::To(PrimitiveType)");
		switch (type)
		{
	...
	unsigned int OGLTypeConverter::To(DepthTestFunction function)
	{
		FN("OGLTypeConverter::To(DepthTestFunction function)");
		switch (function)
		{
		...
		LOG_ASSERT(false, "DepthTestFunction does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(CullFace face)
	{
		FN("OGLTypeConverter::To(CullFace face)");
		switch (face)
		{
			case CullFace::Front:
				return GL_FRONT;
		...
		LOG_ASSERT(false, "CullFace does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(WindingOrder windingOrder)
	{
		FN("OGLTypeConverter::To(WindingOrder windingOrder)");
		switch (windingOrder)
		{
		...
		LOG_ASSERT(false, "WindingOrder does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(RasterizationMode mode)
	{
		FN("OGLTypeConverter::To(RasterizationMode mode)");
		switch (mode)
		{
		...
		LOG_ASSERT(false, "RasterizationMode does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(StencilOperation operation)
	{
		FN("OGLTypeConverter::To(StencilOperation operation)");
		switch (operation)
		{
		...
		LOG_ASSERT(false, "StencilOperation does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(StencilTestFunction function)
	{
		FN("OGLTypeConverter::To(StencilTestFunction function)");
		switch (function)
		{
		...
		LOG_ASSERT(false, "StencilTestFunction does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(BlendEquation equation)
	{
		FN("OGLTypeConverter::To(BlendEquation equation)");
		switch (equation)
		{
		...
		LOG_ASSERT(false, "BlendEquation does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(SourceBlendingFactor factor)
	{
		FN("OGLTypeConverter::To(SourceBlendingFactor factor)");
		switch (factor)
		{
		...
		LOG_ASSERT(false, "SourceBlendingFactor does not exist.");
		return -1;
	}


	unsigned int OGLTypeConverter::To(DestinationBlendingFactor factor)
	{
		FN("OGLTypeConverter::To(DestinationBlendingFactor factor)");
		switch (factor)
		{
		...
		LOG_ASSERT(false, "DestinationBlendingFactor does not exist.");
		return -1;
	}
    ...
    GLenum OGLTypeConverter::TextureToPixelFormat(TextureFormat textureFormat)
    {
        ...
        {
            LOG_ASSERT(false, "Invalid texture format");
			return -1;
        }
		...
		LOG_ASSERT(false, "textureFormat");
		return -1;
    }
	...
	GLenum OGLTypeConverter::TextureToPixelType(TextureFormat textureFormat)
    {
        if (!IsTextureFormatValid(textureFormat))
        {
            LOG_ASSERT(false, "Invalid texture format::textureFormat");
        }
