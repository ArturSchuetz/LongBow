...
namespace Bow {
	namespace Core {
		...
		public:
			...
			inline bool IsVisible(const Core::Vector3<double>& position)
			{
				for (unsigned int i = 0; i < 6; i++)
				{
			...
			inline bool IsTriangleVisible(const Core::Vector3<double>& p0, const Core::Vector3<double>& p1, const Core::Vector3<double>& p2)
			{
